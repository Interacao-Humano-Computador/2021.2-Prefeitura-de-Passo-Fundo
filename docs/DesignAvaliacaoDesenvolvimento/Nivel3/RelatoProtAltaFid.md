...
- Jussara Alves Soares, Técnica em Enfermagem, que satisfaz o perfil de usuário de cidadã que utiliza serviços comuns às prefeituras, como a obtenção de documentos e informações. Foi recrutada pelo aluno <a href="https://github.com/SwampTG">Adrian Soares</a>. A gravação está disponível [aqui](Avaliacao-alta-fid-Jussara.md).
